...
```console
copilot --yolo -i "Implement https://raw.githubusercontent.com/lbussell/metapilot/refs/heads/main/src/copilot-profiles/README.md using $FAVORITE_PROGRAMMING_LANGUAGE and add it to my path/shell profile"
```
